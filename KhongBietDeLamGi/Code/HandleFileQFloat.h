...
inline vector<string> loadDataFromFileFloat(string filename)
{
	fstream file;
...
inline vector<DataFloat> loadDataFromArrayStringFloat(vector<string> str)
{
...
inline vector<string> setDataToVectorStringFloat(vector<DataFloat> vData)
{
	vector<string> resault;

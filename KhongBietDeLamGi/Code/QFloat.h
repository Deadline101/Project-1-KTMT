...
inline string MultiplyStr2(string s);
inline string SubString1(string s);
inline string SubString2(string s);
inline bool ModString2(string s);
inline bool isStrZero(string s);
inline string NormalizeString(std::string& s);
inline string DivideString2(string s);
inline void Padding(string& a, string& b);
inline bool isLargerOrEqual(string a, string b);
inline string SubtractString(string a, string b);
